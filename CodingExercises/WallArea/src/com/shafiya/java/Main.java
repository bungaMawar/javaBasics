...
//        parameters (no-arg constructor). The second constructor has parameters width and height of
//        type double and it needs to initialize the fields. In case the width is less than 0 it needs
//        to set the width field value to 0, in case the height parameter is less than 0 it needs to
